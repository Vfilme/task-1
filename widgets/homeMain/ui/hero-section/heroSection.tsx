    ...
    return (
        <section className={styles.heroSection}>
            <div className={styles.heroText}>
                ...
                <p className={styles.heroDescription}>A place where design philosophy blends innovation and clarity to create impactful solutions</p>
            </div>
            ...
            <Image className={`${styles.blobs} ${styles.blobTopRigth}`} src={BlobTopRigth} alt="" />
            <Image className={`${styles.blobs} ${styles.blobCenter}`} src={BlobCenter} alt="" />
            <Image className={`${styles.blobs} ${styles.blobBottomLeft}`} src={BlobBottomLeft} alt="" />

            <Image src={Star} alt="" className={`${styles.stars} ${styles.starRigth}`}/>
            <Image src={Star} alt="" className={`${styles.stars} ${styles.starLeft}`}/>
